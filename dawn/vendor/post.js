// Generated by dawn/vendor/build-post.mjs from three r0.178.0 examples/jsm.
// Do not edit by hand; see that script's header.
const { ACESFilmicToneMapping, AdditiveBlending, AgXToneMapping, BufferGeometry, CineonToneMapping, Clock, Color, ColorManagement, CustomToneMapping, Float32BufferAttribute, HalfFloatType, LinearToneMapping, Mesh, MeshBasicMaterial, NeutralToneMapping, NoBlending, OrthographicCamera, RawShaderMaterial, ReinhardToneMapping, SRGBTransfer, ShaderMaterial, UniformsUtils, Vector2, Vector3, WebGLRenderTarget } = window.THREE;

// ---- postprocessing/Pass.js (three r0.178.0) ----
...
// ---- postprocessing/MaskPass.js (three r0.178.0) ----
...
// ---- shaders/CopyShader.js (three r0.178.0) ----
/**
 * @module CopyShader
...
// ---- shaders/LuminosityHighPassShader.js (three r0.178.0) ----
...
// ---- shaders/OutputShader.js (three r0.178.0) ----
/**
 * @module OutputShader
...
// ---- postprocessing/ShaderPass.js (three r0.178.0) ----
...
// ---- postprocessing/RenderPass.js (three r0.178.0) ----
...
// ---- postprocessing/EffectComposer.js (three r0.178.0) ----
...
// ---- postprocessing/UnrealBloomPass.js (three r0.178.0) ----
...
// ---- postprocessing/OutputPass.js (three r0.178.0) ----
...
window.__POST = { EffectComposer, RenderPass, ShaderPass, UnrealBloomPass, OutputPass, FullScreenQuad };
